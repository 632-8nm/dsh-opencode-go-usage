...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-19%20passing-22c3a6" alt="测试：19 通过" />
</p>
...
npm test           # 19 个用例(node --test,零依赖;每个测试独立临时 HOME,完全隔离)
...
tests/         # 19 个用例:契约/注册/官方抓取/凭据/快照/空响应诊断/force 刷新/配额兜底/recent 标题/聚合边界/i18n/客户端形态/源码门禁
