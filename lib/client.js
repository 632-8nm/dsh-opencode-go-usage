...
function apply(ctx) {
    ...
    const I18N = {
      zh: {
        ...
        'official.errRunning': '浏览器正在运行,cookie 库被锁定。关闭浏览器后点刷新即可自动提取,或手动粘贴下方凭据。',
      ...
      en: {
        ...
        'official.errRunning': 'A browser is running and its cookie database is locked. Close the browser and refresh to auto-extract, or paste credentials below.',
