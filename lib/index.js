...
export function apply(ctx, config) {
    ...
    async function fetchAll(forceRefresh) {
      ...
      inflight = (async () => {
        ...
        const data = { ok: true, fetchedAt: Date.now(), quota: (quota && !quota.error) ? quota : null, quotaError: (quota && quota.error) || null, quotaLoading: !quota, dsh, dshLoading: !(lastScan && lastScan.rows), official: off || officialErr || { ok: false, loading: true } }
