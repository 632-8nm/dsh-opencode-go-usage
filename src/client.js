  ...
  apply(ctx) {
    ...
    const I18N = {
      zh: {
        ...
        'official.errNoBrowser': '未找到调试浏览器(端口 9222-9230)。点下方按钮一键启动调试浏览器(自动尝试 Edge/Chrome/Brave/Vivaldi/Opera/Arc/Chromium,任装其一即可)并在窗口内登录 opencode.ai,关闭窗口后点"重试提取"即可自动提取;也可手动粘贴下方凭据。',
      ...
      en: {
        ...
        'official.errNoBrowser': 'No debug browser found (ports 9222-9230). Click below to launch one (auto-tries Edge/Chrome/Brave/Vivaldi/Opera/Arc/Chromium — any one installed works), sign in to opencode.ai in the window, close it, then click "Retry extraction". You can also paste credentials below.',
